  ...
  withProgress(message = 'Runing ...', value = 0, {
    ...
    for (i in unique(namesMatrix)) {
      ...
      if (isotopeCorrection == TRUE) {
        ...
        saveWorkbook(wb2, list.files(paste0(results, i), pattern = paste0("IsoCorrectoR_", i, ".xls$"), recursive = TRUE, full.names = TRUE))
        ...
        saveWorkbook(wb3, list.files(paste0(results, i), pattern = paste0("IsoCorrectoR_", i, ".xls$"), recursive = TRUE, full.names = TRUE))
