                 ...
                 if (!is.null(values[["plots_tic"]])) {
                     ...
                     switch(input$graphics,
                            "1" = {
                              ...
                              png(paste0(activePlotsDir,plots_tic$main,"_",input$saveActivePlotsButton,".png"))
                              print(plots_tic)
                              dev.off()
                              })
                            },
                            "2" = {
                              ...
                              ggplot2::ggsave(paste0(plots_tic$labels$title,"_",input$saveActivePlotsButton,".png"), plot = plots_tic, path = activePlotsDir, device = "png")
                              })
                            }
                            )
                 }
                   ...
                   switch(input$graphics,
                          "1" = {
                            lapply(values[["plots_sim"]],function(plots_sim) {
                              ...
                              png(paste0(activePlotsDir,plots_sim$main,"_",input$saveActivePlotsButton,".png"))
                              print(plots_sim)
                              dev.off()
                            })
                          },
                          "2" = {
                            lapply(values[["plots_sim"]],function(plots_sim) {
                              ...
                              ggplot2::ggsave(paste0(plots_sim$labels$title,"_",input$saveActivePlotsButton,".png"), plot = plots_sim, path = activePlotsDir, device = "png")
                            })
                          }
                   )
                 }
                   ...
                   switch(input$graphics,
                          "1" = {
                            lapply(values[["plots_ms"]],function(plots_ms) {
                              ...
                              png(paste0(activePlotsDir,plots_ms$main,"_",input$saveActivePlotsButton,".png"))
                              print(plots_ms)
                              dev.off()
                            })
                          },
                          "2" = {
                            lapply(values[["plots_ms"]],function(plots_ms) {
                              ...
                              ggplot2::ggsave(paste0(plots_ms$labels$title,"_",input$saveActivePlotsButton,".png"), plot = plots_ms, path = activePlotsDir, device = "png")
                            })
                          }
                   )
                 }
